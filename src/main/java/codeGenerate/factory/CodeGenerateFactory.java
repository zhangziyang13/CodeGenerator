...
public class CodeGenerateFactory {
	...
	public static void codeGenerate(String tableName, String codeName, String entityPackage, String keyType, String pageFolder,
		...
		String srcPath = projectPath + CodeResourceUtil.source_root_package + "\\main\\java\\";
...
//		webPath = webPath + entityPackage + "\\";
		...
		//CommonPageParser.WriterPage(context, "jsTemplate.ftl", webPath.replace(pageFolder, "js"), jsPath);
