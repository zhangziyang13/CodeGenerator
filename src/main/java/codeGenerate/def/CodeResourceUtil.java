...
{
  private static final ResourceBundle bundle = ResourceBundle.getBundle("config/database");
  private static final ResourceBundle bundlePath = ResourceBundle.getBundle("config/config");
  public static String DIVER_NAME = "com.mysql.jdbc.Driver";
  public static String URL = "jdbc:mysql://localhost:3306/core?useUnicode=true&characterEncoding=UTF-8";
  ...
  public static String acccode = "946b8a59-9d0f-4adf-9a7e-b0cdfcf83490";
  ...
  private static String getAcccode() {
    return bundlePath.getString("acccode");
  }
